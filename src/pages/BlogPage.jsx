      ...
      <div className="z-10 w-full max-w-3xl">
        ...
        <div className="text-center mb-10">
          <motion.h1 
            ...
            transition={{ duration: 0.5 }}
            className="text-4xl md:text-6xl font-black text-slate-900 dark:text-slate-100 tracking-tighter mb-4">
          ...
          <motion.p 
            ...
            className="text-slate-500 dark:text-slate-200 font-medium text-lg max-w-xl mx-auto">
        ...
        <motion.div 
          ...
          className="bg-slate-900 rounded-2xl p-6 shadow-2xl border border-slate-800 mb-10 overflow-hidden relative">
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row items-center justify-between gap-6 border-t border-slate-100 dark:border-[#324467]/20 pt-8">
          ...
          <div className="flex items-center gap-4">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-4 py-2 rounded-full dark:bg-[#192233] border border-slate-200 dark:border-[#324467] text-slate-600 dark:text-white font-bold text-sm hover:bg-slate-50 dark:hover:bg-[#232f48] transition-all">
              <Share2 size={16} /> Share Grid
            </motion.button>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-[#135bec] text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg shadow-blue-500/20 transition-all">
              Notify Me
            </motion.button>
          </div>
        </motion.div>
