    ...
    <div className="min-h-screen bg-white dark:bg-[#050a18] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-2xl text-center">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 text-red-600 text-[10px] font-black uppercase tracking-[0.2em]">
            <ShieldAlert size={14} /> Security Protocol: Active
          </div>
          <h1 className="text-5xl md:text-6xl font-black text-slate-900 dark:text-slate-200 tracking-tighter">
            WHITEPAPER <span className="text-[#135bec]">2.0</span>
          </h1>
        </div>

        {/* Coming Soon Message Box */}
        <div className="bg-slate-50 dark:bg-[#0d1425]/70 border border-slate-100 dark:border-[#324467] rounded-3xl p-8 mb-10 relative overflow-hidden">
            <div className="relative z-10">
                ...
                <div className="inline-block px-8 py-4 bg-white dark:bg-white/5 border-2 border-[#135bec] rounded-2xl shadow-xl shadow-blue-500/10">
